...
namespace ProjAula06092021.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public CarrosController(ProjAula06092021Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cor,Ano,Modelo,Placa")] Carros carros)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cor,Ano,Modelo,Placa")] Carros carros)
        {
            if (id != carros.Id)
            {
                return NotFound();
